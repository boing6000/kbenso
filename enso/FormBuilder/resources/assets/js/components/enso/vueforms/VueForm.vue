<template>
    ...
    <div>
        ...
        <form class="is-marginless"
            ...
            <a class="button"
                v-if="data.actions.destroy && !data.actions.destroy.hidden"
            ...
            <a class="button"
                ...
                @click="show()"
                v-if="data.actions.show && !data.actions.show.hidden"
            ...
            <a class="button"
                ...
                @click="create()"
                v-if="data.actions.create && !data.actions.create.hidden"
            ...
            <a class="button"
               :class="data.actions.index.button.class"
               @click="back()"
               v-if="data.actions.index && !data.actions.index.hidden"
               :disabled="data.actions.index.forbidden">
                <span class="is-hidden-mobile">
                    {{ i18n(data.actions.index.button.label) }}
                </span>
                <span class="icon">
                    <fa :icon="data.actions.index.button.icon"></fa>
                </span>
                <span class="is-hidden-mobile">
                </span>
            </a>
            <button type="submit"
                v-if="data.actions.store && !data.actions.store.hidden"
            ...
            <button type="submit"
                v-if="data.actions.update && !data.actions.update.hidden"
                class="button is-pulled-right"
...
export default {
    ...
    components: {
        Divider, VueSwitch, Modal, Datepicker, Money,
    },
    ...
    methods: {
        ...
        back() {
            this.$emit('back');
            this.$router.push({ name: this.data.actions.index.route });
        },
        submit() {
            this.loading = true;
